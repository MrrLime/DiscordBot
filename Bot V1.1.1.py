...
async def help(ctx):
  embed = discord.Embed(title="Help",url="https://github.com/MrrLime/DiscordBot", description="All commands and there usage", color=colours.get("Cyan"))
...
bot.run("OTIzMzIxNjM1OTcxNDEyMDQw.YcOUSA.uEa79SiP0-m2bIQzIkyNImcQh7Q")
